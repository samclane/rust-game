...
use noise::{core::worley::ReturnType, Add, Fbm, MultiFractal, NoiseFn, Perlin, Worley};
use rand::Rng;

const NEBULA_FREQUENCY: f64 = 2.0;
const STAR_FREQUENCY: f64 = 100.0;
